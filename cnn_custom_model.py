...
class FaceRecognitionModel:
    ...
    def build_model(self):
        ...
        model = models.Sequential([
            # Block 1
            layers.Conv2D(32, (3, 3), padding='same', input_shape=(self.config.IMG_SIZE[0], self.config.IMG_SIZE[1], 3), activation="relu"),
            ...
            layers.BatchNormalization(),
            layers.Dropout(0.3),
            layers.Dense(len(self.config.LABELS), activation='softmax'),
        ])
